...
Future main() async {
  ...
  if(kIsWeb){
    await Firebase.initializeApp(options: FirebaseOptions(apiKey:  "AIzaSyCyGd_TnVE86_vGJ38yy8lbfPpdGmahhGU", appId: "1:610745408165:web:7ac661544723e2652b8b4c", messagingSenderId:  "610745408165", projectId: "showigu-cdf41") );
  }
  runApp(const MyApp());
}
